...
if __name__ == '__main__':
    server = InboundCallServer(
        ...
        account_sid="AC161572083b62e78f86b56c45b5229b70",
        auth_token="8a701e3766e6b31b91e691ca4c7e74c0",
        ),
  )  
    server.app.get("/")(lambda: Response(
        content= f"<div>Paste the following URL into your Twilio config: {REPLIT_URL}/vocode", media_type="text/html"))
